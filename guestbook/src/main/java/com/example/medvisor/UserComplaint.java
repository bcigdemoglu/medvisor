...
public class UserComplaint {
   ...
   **/
  public UserComplaint(String content) {
    this();
   ...
   **/
  public UserComplaint(String content, String id, String email) {
    this(content);
    userEmail = Key.create(UserInfo.class, email);
    author_email = email;
    author_id = id;
  }
